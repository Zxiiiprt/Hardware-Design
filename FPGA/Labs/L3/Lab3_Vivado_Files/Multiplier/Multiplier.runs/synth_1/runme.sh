...
HD_PWD='C:/Users/anyho/FPGA/Projects/SYSC3320/Labs/Lab3/Multiplier/Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Multiplier.tcl

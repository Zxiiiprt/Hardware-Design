...
HD_PWD='C:/Users/anyho/FPGA/Projects/SYSC3320/Labs/Lab3/Multiplier/Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Multiplier.tcl -notrace

...
HD_PWD='C:/Users/anyho/FPGA/Projects/SYSC3320/Lab2_Decoder_2_4/Lab2_Decoder_2_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Decoder_2_to_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Decoder_2_to_4.tcl
